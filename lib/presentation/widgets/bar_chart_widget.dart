...
class BarChartWidget extends StatefulWidget {
  const BarChartWidget({super.key, required this.expense});
...
class _BarChartWidgetState extends State<BarChartWidget> {
  ...
  final Color barColor = Palette.textDark;
  final Color touchedBarColor = Palette.pinkMocha;
